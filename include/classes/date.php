...
/**
 * Fonctions de base pour le traitement des dates, des timestamps MYSQL et des fuseaux horaires.
...
abstract class date {
    ...
    public static function dateverify($mydate)
    {
    ...
    public static function createdatetime() { return date(_PLOOPI_DATETIMEFORMAT_MYSQL); }
    ...
    public static function unixtimestamp2local($mytimestamp) { return(date(_PLOOPI_DATEFORMAT,$mytimestamp).' '.date(_PLOOPI_TIMEFORMAT,$mytimestamp)); }
    ...
    public static function unixtimestamp2timestamp($mytimestamp) { return(date(_PLOOPI_TIMESTAMPFORMAT_MYSQL,$mytimestamp)); }
    ...
    public static function unixtimestamp2datetime($mytimestamp) { return(date(_PLOOPI_DATETIMEFORMAT_MYSQL,$mytimestamp)); }
    ...
    public static function timestamp2unixtimestamp($mytimestamp)
    {
        $timestp_array = self::gettimestampdetail($mytimestamp);
    ...
    public static function datetime2timestamp($mydatetime)
    {
    ...
    public static function datetime2unixtimestamp($mydatetime)
    {
        return self::timestamp2unixtimestamp(self::datetime2timestamp($mydatetime));
    }
    ...
    public static function datetime2local($mydatetime)
    {
        return self::timestamp2local(self::datetime2timestamp($mydatetime));
    }
    ...
    public static function timestamp2local($mytimestamp)
    {
        ...
        $timestamparray = self::gettimestampdetail($mytimestamp);
    ...
    public static function timestamp2xls($intTs)
    {
        $intTs = self::timestamp2unixtimestamp($intTs);
    ...
    public static function local2datetime($mydate, $mytime = '00:00:00')
    {
        // verify local format
        if (self::dateverify($mydate))// && self::timeverify($mytime))
        {
    ...
    {
        $timestp_array = self::gettimestampdetail($timestp);
    ...
    {
        $timestp_array = self::gettimestampdetail(self::datetime2timestamp($datetime));
    ...
    public static function tz_createtimestamp($timezone_name = 'UTC')
    {
    ...
    public static function tz_timestamp2timestamp($ts, $timezone_name_src = 'UTC', $timezone_name_dst = 'UTC')
    {
    ...
    public static function tz_getutc($timezone_name = 'UTC')
    {
        switch($timezone_name)
        {
            case 'user':
    ...
    public static function open_calendar($strInputFieldId, $booEcho = true, $strClass = null, $strStyle = null)
    {
        ...
        $strEcho = "
            <a href=\"javascript:void(0);\" onclick=\"javascript:ploopi_xmlhttprequest_topopup(192, event, 'ploopi_popup_calendar', '".crypt::urlencode("{$strScript}-light.php?ploopi_op=calendar_open")."', 'selected_date='+$('{$strInputFieldId}').value+'&inputfield_id={$strInputFieldId}', 'POST', true);\" {$strClass}{$strStyle}>
