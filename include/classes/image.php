...
abstract class fs
{
    ...
    public static function resize($imagefile, $coef = 0, $wmax = 0, $hmax = 0, $format = '', $nbcolor = 0, $filename = '', $centerwidthcolor = false, $bgcolor = false)
    {
        ...
        if(!empty($centerwidthcolor))
        {
            ...
            else
            {
                ...
                $arrColor = str::color_hex2rgb($centerwidthcolor);
