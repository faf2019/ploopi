    ...
    <div class="form_row" style="margin-top:{formfields.switch_field.INTERLINE}px;">
        ...
        <span class="field">
            ...
            <!-- BEGIN switch_radio -->
                <!-- BEGIN values -->
                <div>
                    <div class="form_checkzone"><input {formfields.switch_field.switch_radio.values.CHECKED} type="checkbox" class="form_checkbox" name="{formfields.switch_field.switch_radio.values.NAME}" value="{formfields.switch_radio.switch_select.values.VALUE}"></div>
