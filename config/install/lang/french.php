...
define ('_PLOOPI_INSTALL_PEAR_XML_SERIALIZER',            '---- Contrôle du package PEAR : XML_Serializer');
...
define ('_PLOOPI_INSTALL_PEAR_NET_USERAGENT_DETECT',      '---- Contrôle du package PEAR : Net_UserAgent_Detect');
...
* Stage 4
*********/
define ('_PLOOPI_INSTALL_DATA_BASE',         'Paramétrage de la base de donnée');
