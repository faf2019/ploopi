...
define('ABSOLUTE_SCRIPT_PATH','/data/nux2/faf/ploopi_redist_v3beta/phpdig'); // full path up to but not including admin dir, no end slash
...
define('PHPDIG_VERSION','1.8.8');

$phpdig_language = "fr"; // ca, cs, da, de, en, es, fr, gr, it, nl, no, pt
...
if (isset($template_path)) $template = ".{$template_path}/phpdig.tpl";
...
$phpdig_string_subst['iso-8859-7'] = 'á:Á¶Ü,â:Â,ã:Ã,ä:Ä,å:Å¸Ý,æ:Æ,ç:ÞÇ¹,è:è,é:ßúÉº,ê:Ê,ë:Ë,ì:Ì,í:Í,î:Î,ï:ü¼Ï,ð:Ð,ñ:Ñ,ó:Óò,ô:Ô,õ:ýûÕ¾,ö:Ö,÷:×,ø:Ø,ù:þÙ¿';
...
define('PHPDIG_PARSE_MSWORD','/usr/bin/catdoc');
...
define('PHPDIG_PARSE_MSEXCEL','/usr/bin/xls2csv');
define('PHPDIG_OPTION_MSEXCEL','');

define('PHPDIG_INDEX_MSPOWERPOINT',true);
define('PHPDIG_PARSE_MSPOWERPOINT','/usr/bin/catppt');
