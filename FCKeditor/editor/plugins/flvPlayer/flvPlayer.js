...
Media.prototype.getInnerHTML = function (objectId){
    ...
    s+= '<script src="' + oEditor.FCKConfig.BaseHref + 'lib/swfobject/swfobject.js" type="text/javascript"></script>\n';
    ...
    s+= '   var s1 = new SWFObject("' + oEditor.FCKConfig.BaseHref + 'lib/jw_player/player-viral.swf","' + thisMediaType + '","' + thisWidth + '","' + thisHeight + '","7");\n';
