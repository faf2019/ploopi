...
FCKCommands.RegisterCommand( 'PloopiObjects'    , new FCKDialogCommand( FCKLang['DlgPloopiObjectsTitle']    , FCKLang['DlgPloopiObjectsTitle']      , FCKConfig.BaseHref + '/admin-light.php?ploopi_op=ploopi_getobjects' , 340, 170 ) ) ;
