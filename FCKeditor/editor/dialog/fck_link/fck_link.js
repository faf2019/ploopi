...
function LoadSelection()
{
    ...
    // Look for file link
    if (sHRef.substr(0,15)  == 'index-light.php')
    {
        sType = 'file' ;
        GetE('txtFile').value = sHRef ;
    }
    else if (sHRef.substr(0,9)  == 'index.php' && FCKConfig.LinkArticle)
    { // Look for article link
        sType = 'article' ;
        GetE('txtArticle').value = sHRef ;
    }
    if ( sProtocol )
	{
...
{
    if (FCKConfig.LinkArticle) ShowE('divLinkTypeArticle'   , (linkType == 'article') ) ;
