...
if (ploopi_ismoduleallowed('directory'))
{
    switch($ploopi_op)
    {
        ...
        case 'directory_list_modify':
            ...
            ?>
            <form method="post" target="iframe_directory_list_add" onsubmit="javascript:return directory_list_validate(this);" >
            ...
            <iframe name="iframe_directory_list_add" style="display:none;" src="./img/blank.gif"></iframe>
            <?
        ...
        case 'directory_list_save':
            ...
            <script type="text/javascript">
                ...
                window.parent.document.location.href='<? echo ploopi_urlencode("admin.php?directoryTabItem=tabFavorites&directory_favorites_id_list={$directory_favorites_id_list}"); ?>';
            </script>
            <?
            ploopi_die();
        break;
