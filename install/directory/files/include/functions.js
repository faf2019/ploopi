function directory_list_change(list)
{
    ...
    ploopi_xmlhttprequest_todiv('admin-light.php', 'ploopi_op=directory_favorites&directory_favorites_id_list='+list.value, '', 'directory_favorites_list');
}

function directory_list_addnew(e)
{
    ploopi_showpopup(ploopi_ajaxloader_content, 300, e, 'click', 'popup_directory_list_form');
    ploopi_xmlhttprequest_todiv('admin-light.php','ploopi_op=directory_list_addnew', '', 'popup_directory_list_form');   
}

function directory_list_modify(e)
{
    ploopi_showpopup(ploopi_ajaxloader_content, 300, e, 'click', 'popup_directory_list_form');
    ploopi_xmlhttprequest_todiv('admin-light.php','ploopi_op=directory_list_modify&directory_favorites_id_list='+$('directory_favorites_id_list').value, '', 'popup_directory_list_form');   
}
...
function directory_addtofavorites(e, id_user, id_contact)
{
    ...
    ploopi_xmlhttprequest_todiv('admin-light.php', 'ploopi_op=directory_getlists&directory_favorites_id_user='+id_user+'&directory_favorites_id_contact='+id_contact, '', 'popup_directory_addtofavorites');
}
...
function directory_view(e, id_user, id_contact)
{
    ...
    ploopi_xmlhttprequest_todiv('admin-light.php', 'ploopi_op=directory_view&directory_id_user='+id_user+'&directory_id_contact='+id_contact, '', popid);
}