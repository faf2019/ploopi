<?php
/**
 * Administration / Gestion des departements
 * 
 * @package espacedoc
 * @subpackage admin
...
<div class="espacedoc_toolbar">
    ...
    <a href="javascript:void(0);" onclick="javascript:espacedoc_element_supprimer('departement');"><img src="./modules/espacedoc/img/ico_trash.png">Supprimer les éléments cochés</a>
    <a href="javascript:void(0);" onclick="javascript:espacedoc_element_ajouter('departement', event);"><img src="./modules/espacedoc/img/ico_new.png">Ajouter un élément</a>
</div>
...
$sql =  "
        ...
        FROM        ploopi_mod_espacedoc_departement t
        
        LEFT JOIN   ploopi_mod_espacedoc_document d
        ON          d.id_departement = t.id
...
while ($row = $db->fetchrow())
{
    ...
    $array_values[$c]['onclick'] = "espacedoc_element_modifier('departement', {$row['id']}, event);";
    $array_values[$c]['style'] = '';
    $c++;
}

$skin->display_array($array_columns, $array_values, 'espacedoc_departement', array('height' => 400, 'sortable' => true, 'orderby_default' => 'libelle', 'sort_default' => 'ASC'));
?>
