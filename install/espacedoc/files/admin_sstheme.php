<?php
/**
 * Administration / Gestion des sous-thèmes
 * 
 * @package espacedoc
 * @subpackage admin
...
<div class="espacedoc_toolbar">
    ...
    <a href="javascript:void(0);" onclick="javascript:espacedoc_element_supprimer('sstheme');"><img src="./modules/espacedoc/img/ico_trash.png">Supprimer les éléments cochés</a>
    <a href="javascript:void(0);" onclick="javascript:espacedoc_element_ajouter('sstheme', event);"><img src="./modules/espacedoc/img/ico_new.png">Ajouter un élément</a>
</div>
