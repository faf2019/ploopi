  ...
  */
 	...
 	// Default Options
		var defaultOptions = {
			...
			boxImage	: './modules/espacedoc/img/bramus/percentImage.png',			// boxImage : image around the progress bar
			barImage	: './modules/espacedoc/img/ajaxbar.png',	// Image to use in the progressbar. Can be an array of images too.
