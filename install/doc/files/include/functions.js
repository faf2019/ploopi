            ...
            onSuccess:  function(transport, json)
            {
                ...
                if (json)
                {
                    ...
                    for (i=0;i<json.length;i++)
                    {
                        ...
                        {
                            fb.innerHTML +=     '<a class="doc_fckexplorer_vignette" href="javascript:void(0);" onclick="javascript:ploopi_getelem(\'txtUrl\',opener.document).value=\''+json[i]['url']+'\';ploopi_getelem(\'txtAttTitle\',opener.document).value=\''+json[i]['name']+'\';ploopi_getelem(\'txtAlt\',opener.document).value=\''+json[i]['name']+'\';opener.UpdatePreview();window.close();">'+
                        ...
                        {
                            fb.innerHTML +=     '<a class="doc_fckexplorer_vignette" href="javascript:void(0);" onclick="javascript:ploopi_getelem(\'txtUrl\',opener.document).value=\''+json[i]['url']+'\';ploopi_getelem(\'txtAttTitle\',opener.document).value=\''+json[i]['name']+'\';opener.UpdatePreview();window.close();">'+
                                                    '<div style="font-weight:bold;">'+json[i]['name']+'</div>'+
                                                    '<div>'+filesize+' ko</div>'+
                                                '</a>';
                        }
                        ...
                        {
                            fb.innerHTML +=     '<a class="doc_fckexplorer_file" href="javascript:void(0);" onclick="javascript:ploopi_getelem(\'txtUrl\',opener.document).value=\''+json[i]['url']+'\';ploopi_getelem(\'cmbLinkProtocol\',opener.document).value=\'\';ploopi_getelem(\'txtAttTitle\',opener.document).value=\''+json[i]['name']+'\';window.close();">'+
                                                    '<div style="font-weight:bold;">'+json[i]['name']+'</div>'+
                                                    '<div>'+filesize+' ko</div>'+
                                                '</a>';
                        }
