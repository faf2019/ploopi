...
<div class="doc_folderinfo ploopi_va" style="padding:2px;display:<?php echo ($show_options) ? 'block' : 'none'; ?>;border-top:1px solid #c0c0c0;" id="doc_search_options">
    ...
    <input type="text" style="width:90px;" placeholder="Propriétaire" value="<?php echo ploopi_htmlentities($_SESSION['doc'][$_SESSION['ploopi']['moduleid']]['search_user']); ?>" id="doc_search_user">
