--
-- Structure de la table `ploopi_annotation`
--
...
--
-- Contenu de la table `ploopi_annotation`
--
...
--
-- Structure de la table `ploopi_annotation_tag`
--
...
--
-- Contenu de la table `ploopi_annotation_tag`
--
...
--
-- Structure de la table `ploopi_captcha`
--
...
--
-- Contenu de la table `ploopi_captcha`
--
...
--
-- Structure de la table `ploopi_confirmation_code`
--
...
--
-- Contenu de la table `ploopi_confirmation_code`
--
...
--
-- Structure de la table `ploopi_connecteduser`
--
...
--
-- Contenu de la table `ploopi_connecteduser`
--
...
--
-- Structure de la table `ploopi_documents_ext`
--
...
--
-- Contenu de la table `ploopi_documents_ext`
--
...
--
-- Structure de la table `ploopi_documents_file`
--
...
--
-- Contenu de la table `ploopi_documents_file`
--
...
--
-- Structure de la table `ploopi_documents_folder`
--
...
--
-- Contenu de la table `ploopi_documents_folder`
--
...
--
-- Structure de la table `ploopi_group`
--
...
--
-- Contenu de la table `ploopi_group`
--
...
--
-- Structure de la table `ploopi_group_user`
--
...
--
-- Contenu de la table `ploopi_group_user`
--
...
--
-- Structure de la table `ploopi_index_element`
--
...
--
-- Contenu de la table `ploopi_index_element`
--
...
--
-- Structure de la table `ploopi_index_keyword`
--

DROP TABLE IF EXISTS `ploopi_index_keyword`;
CREATE TABLE IF NOT EXISTS `ploopi_index_keyword` (
  `id` char(32) NOT NULL,
...
--
-- Contenu de la table `ploopi_index_keyword`
--
...
--
-- Structure de la table `ploopi_index_keyword_element`
--
...
--
-- Contenu de la table `ploopi_index_keyword_element`
--
...
--
-- Structure de la table `ploopi_index_stem`
--

DROP TABLE IF EXISTS `ploopi_index_stem`;
CREATE TABLE IF NOT EXISTS `ploopi_index_stem` (
...
--
-- Contenu de la table `ploopi_index_stem`
--
...
--
-- Structure de la table `ploopi_index_stem_element`
--
...
--
-- Contenu de la table `ploopi_index_stem_element`
--
...
--
-- Structure de la table `ploopi_log`
--
...
--
-- Contenu de la table `ploopi_log`
--
...
--
-- Structure de la table `ploopi_mb_action`
--
...
--
-- Contenu de la table `ploopi_mb_action`
--
...
(1, 24, 'Mettre �  jour la Métabase', NULL, 0, 0, 1),
...
(1, 32, 'Mettre �  jour un module', NULL, 0, 0, 1),
(1, 39, 'Cr�er un Espace de Travail', NULL, 0, 0, 1),
(1, 40, 'Modifier un Espace de Travail', NULL, 0, 0, 1),
(1, 41, 'Supprimer un Espace de Travail', NULL, 0, 0, 1),
(1, 42, 'Cl�ner un Espace de Travail', NULL, 0, 0, 1);
...
--
-- Structure de la table `ploopi_mb_object`
--
...
--
-- Contenu de la table `ploopi_mb_object`
--
...
--
-- Structure de la table `ploopi_mb_wce_object`
--
...
--
-- Contenu de la table `ploopi_mb_wce_object`
--
...
--
-- Structure de la table `ploopi_mimetype`
--
...
--
-- Contenu de la table `ploopi_mimetype`
--
...
--
-- Structure de la table `ploopi_module`
--
...
--
-- Contenu de la table `ploopi_module`
--
...
--
-- Structure de la table `ploopi_module_type`
--
...
--
-- Contenu de la table `ploopi_module_type`
--

INSERT INTO `ploopi_module_type` (`id`, `label`, `system`, `publicparam`, `description`, `version`, `author`, `date`) VALUES
(1, 'system', 1, 0, 'Noyau du syst�me', '1.9.0', 'Ovensia', '20111219000000');

-- --------------------------------------------------------

--
-- Structure de la table `ploopi_module_workspace`
--
...
--
-- Contenu de la table `ploopi_module_workspace`
--
...
--
-- Structure de la table `ploopi_param_choice`
--
...
--
-- Contenu de la table `ploopi_param_choice`
--
...
--
-- Structure de la table `ploopi_param_default`
--
...
--
-- Contenu de la table `ploopi_param_default`
--
...
--
-- Structure de la table `ploopi_param_type`
--
...
--
-- Contenu de la table `ploopi_param_type`
--
...
(1, 'system_search_displayindexed', '0', 0, '', 'Afficher la colonne "Index� le" dans la recherche'),
...
(1, 'system_search_displaydatetime', '0', 0, '', 'Afficher la colonne "Ajout� le" dans la recherche'),
...
--
-- Structure de la table `ploopi_param_user`
--
...
--
-- Contenu de la table `ploopi_param_user`
--
...
--
-- Structure de la table `ploopi_param_workspace`
--
...
--
-- Contenu de la table `ploopi_param_workspace`
--
...
--
-- Structure de la table `ploopi_role`
--
...
--
-- Contenu de la table `ploopi_role`
--
...
--
-- Structure de la table `ploopi_role_action`
--
...
--
-- Contenu de la table `ploopi_role_action`
--
...
--
-- Structure de la table `ploopi_serializedvar`
--
...
--
-- Contenu de la table `ploopi_serializedvar`
--
...
--
-- Structure de la table `ploopi_session`
--
...
--
-- Contenu de la table `ploopi_session`
--
...
--
-- Structure de la table `ploopi_share`
--
...
--
-- Contenu de la table `ploopi_share`
--
...
--
-- Structure de la table `ploopi_subscription`
--
...
--
-- Contenu de la table `ploopi_subscription`
--
...
--
-- Structure de la table `ploopi_subscription_action`
--
...
--
-- Contenu de la table `ploopi_subscription_action`
--
...
--
-- Structure de la table `ploopi_tag`
--
...
--
-- Contenu de la table `ploopi_tag`
--
...
--
-- Structure de la table `ploopi_ticket`
--
...
--
-- Contenu de la table `ploopi_ticket`
--
...
--
-- Structure de la table `ploopi_ticket_dest`
--
...
--
-- Contenu de la table `ploopi_ticket_dest`
--
...
--
-- Structure de la table `ploopi_ticket_status`
--
...
--
-- Contenu de la table `ploopi_ticket_status`
--
...
--
-- Structure de la table `ploopi_ticket_watch`
--
...
--
-- Contenu de la table `ploopi_ticket_watch`
--
...
--
-- Structure de la table `ploopi_user`
--
...
--
-- Contenu de la table `ploopi_user`
--
...
--
-- Structure de la table `ploopi_user_action_log`
--
...
--
-- Contenu de la table `ploopi_user_action_log`
--
...
--
-- Structure de la table `ploopi_validation`
--
...
--
-- Contenu de la table `ploopi_validation`
--
...
--
-- Structure de la table `ploopi_workspace`
--
...
--
-- Contenu de la table `ploopi_workspace`
--
...
--
-- Structure de la table `ploopi_workspace_group`
--
...
--
-- Contenu de la table `ploopi_workspace_group`
--
...
--
-- Structure de la table `ploopi_workspace_group_role`
--
...
--
-- Contenu de la table `ploopi_workspace_group_role`
--
...
--
-- Structure de la table `ploopi_workspace_user`
--
...
--
-- Contenu de la table `ploopi_workspace_user`
--
...
--
-- Structure de la table `ploopi_workspace_user_role`
--
...
--
-- Contenu de la table `ploopi_workspace_user_role`
--
...
UPDATE `ploopi_module_type` SET `version` = '1.9.0.1', `author` = 'Ovensia', `date` = '20120113000000', `description` = 'Noyau du syst�me' WHERE `ploopi_module_type`.`id` = 1;