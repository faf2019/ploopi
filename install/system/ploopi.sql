...
INSERT INTO `ploopi_module_type` VALUES (1,'system',1,0,NULL,'1.0 RC7','Ovensia','20080722000000');
...
ALTER TABLE `ploopi_annotation_tag` ADD PRIMARY KEY ( `id_annotation` , `id_tag` ) ; /* pb d'unicité => réglé */
ALTER TABLE `ploopi_annotation_tag` DROP INDEX `id_annotation` ;
ALTER TABLE `ploopi_index_keyword_element` ADD PRIMARY KEY ( `id_keyword` , `id_element` ) ; /* pb d'unicité */
ALTER TABLE `ploopi_index_keyword_element` DROP INDEX `id_keyword`;
ALTER TABLE `ploopi_index_stem_element` ADD PRIMARY KEY ( `id_stem` , `id_element` ) ; /* pb d'unicité */
ALTER TABLE `ploopi_index_stem_element` DROP INDEX `id_stem`;
