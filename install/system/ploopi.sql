...
INSERT INTO `ploopi_mb_action` VALUES (1,1,'Installer un Module',NULL,0,0,1),(1,2,'DÈsinstaller un Module',NULL,0,0,1),(1,3,'Modifier les ParamËtres d\'un Module',NULL,0,0,1),(1,4,'Instancier / Utiliser un Module',NULL,0,0,1),(1,5,'Modifier les PropriÈtÈs d\'un Module',NULL,0,0,1),(1,6,'Modifier la Page d\'Accueil',NULL,0,0,1),(1,7,'Installer un Skin',NULL,0,0,1),(1,8,'DÈsinstaller un Skin',NULL,0,0,1),(1,9,'CrÈer un Groupe',NULL,0,0,1),(1,10,'Modifier un Groupe',NULL,0,0,1),(1,11,'Supprimer un Groupe',NULL,0,0,1),(1,12,'Cloner un Groupe',NULL,0,0,1),(1,13,'CrÈer un RÙle',NULL,0,0,1),(1,14,'Modifier un RÙle',NULL,0,0,1),(1,15,'Supprimer un RÙle',NULL,0,0,1),(1,16,'CrÈer un Profil',NULL,0,0,1),(1,17,'Modifier un Profil',NULL,0,0,1),(1,18,'Supprimer un Profil',NULL,0,0,1),(1,19,'Ajouter un Utilisateur',NULL,0,0,1),(1,20,'Modifier un Utilisateur',NULL,0,0,1),(1,21,'Supprimer un Utilisateur',NULL,0,0,1),(1,22,'DÈtacher un Module',NULL,0,0,1),(1,23,'Supprimer un Module',NULL,0,0,1),(1,24,'Mettre ‡ jour la MÈtabase',NULL,0,0,1),(1,25,'Connexion Utilisateur',NULL,0,0,1),(1,26,'Erreur de Connexion',NULL,0,0,1),(1,27,'DÈplacer un Utilisateur',NULL,0,0,1),(1,28,'Attacher un Utilisateur',NULL,0,0,1),(1,29,'DÈtacher un Utilisateur',NULL,0,0,1),(1,32,'Mettre ‡ jour un module',NULL,0,0,1);
...
INSERT INTO `ploopi_param_type` VALUES (1,'system_generate_htpasswd','1',0,'','GÈnÈrer un fichier htpasswd'),(1,'system_language','',1,'','Langue du systËme');
