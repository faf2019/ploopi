...
UPDATE `ploopi_module_type` SET `version` = '1.8.0', `author` = 'Ovensia', `date` = '20101214000000', `description` = 'Noyau du système' WHERE `ploopi_module_type`.`id` = 1;
...
UPDATE `ploopi_module_type` SET `version` = '1.8.0.1', `author` = 'Ovensia', `date` = '20120113000000', `description` = 'Noyau du système' WHERE `ploopi_module_type`.`id` = 1;