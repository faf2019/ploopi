...
(1, 'system', 1, 0, 'Noyau du système', '1.9.0', 'Ovensia', '20111219000000');
...
UPDATE `ploopi_module_type` SET `version` = '1.9.3.10', `author` = 'Ovensia', `date` = '20150220000000', `description` = 'Noyau du système' WHERE `ploopi_module_type`.`id` = 1;
