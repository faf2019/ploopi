...
?>
<form id="booking_form_view" action="<? echo ploopi_urlencode("admin.php?booking_menu=monitoring"); ?>" method="post">
            ...
            array(
                'values' => 
                    array(
                        ...
                        'user' => array('label' => "{$row['u_lastname']} {$row['u_firstname']} <br /><em>de {$row['w_label']}</em>")
                    ),
