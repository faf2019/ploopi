...
switch ($strbackendtype)
{
    ...
    case 'feedRssAtom' :
        ...
        if (!$objCache->start())
        {
            ...
            {
                $where = '';
                $feed_title = isset($_SESSION['ploopi']['workspaces'][$_SESSION['ploopi']['workspaceid']]['title']) ? $_SESSION['ploopi']['workspaces'][$_SESSION['ploopi']['workspaceid']]['title'] : ''
                $feed_description = isset($_SESSION['ploopi']['workspaces'][$_SESSION['ploopi']['workspaceid']]['meta_description']) ? $_SESSION['ploopi']['workspaces'][$_SESSION['ploopi']['workspaceid']]['meta_description'] : '';
            }
            ...
            $feed->setChannelElement('author', array('name '=> ploopi_xmlentities(utf8_encode(isset($_SESSION['ploopi']['workspaces'][$_SESSION['ploopi']['workspaceid']]['meta_author']) ? $_SESSION['ploopi']['workspaces'][$_SESSION['ploopi']['workspaceid']]['meta_author'] : ''), true)));
