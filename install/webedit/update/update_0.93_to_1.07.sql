ALTER TABLE `dims_mod_wce_heading` ADD `color` VARCHAR( 32 ) NOT NULL AFTER `position` ,
ADD `posx` INT( 10 ) UNSIGNED NOT NULL DEFAULT '0' AFTER `color` ,
ADD `posy` INT( 10 ) UNSIGNED NOT NULL DEFAULT '0' AFTER `posx` ,
ADD `visible` TINYINT( 1 ) UNSIGNED NOT NULL DEFAULT '0' AFTER `posy` ,
ADD `linkedpage` INT( 10 ) UNSIGNED NOT NULL DEFAULT '0' AFTER `visible` ;

ALTER TABLE `dims_mod_wce_heading` CHANGE `id_group` `id_workspace` INT( 10 ) UNSIGNED NULL DEFAULT '0';
ALTER TABLE `dims_mod_wce_article` CHANGE `id_group` `id_workspace` INT( 10 ) UNSIGNED NULL DEFAULT '0';
ALTER TABLE `dims_mod_wce_article_draft` CHANGE `id_group` `id_workspace` INT( 10 ) UNSIGNED NULL DEFAULT '0';
