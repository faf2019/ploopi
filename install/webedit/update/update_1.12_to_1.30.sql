...
RENAME TABLE `dims_mod_webedit_article` TO `ploopi_mod_webedit_article`;
RENAME TABLE `dims_mod_webedit_article_backup` TO `ploopi_mod_webedit_article_backup`;
RENAME TABLE `dims_mod_webedit_article_draft` TO `ploopi_mod_webedit_article_draft`;
RENAME TABLE `dims_mod_webedit_heading` TO `ploopi_mod_webedit_heading`;
