            ...
            if (!empty($rssfeed->fields['url']))
            {
                ...
                while ($fields = $db->fetchrow($result))
                {
                  ...
                  $template_rss->assign_block_vars('rss_entry',array(
                              ...
                              'TITLE_CLEAN' => ploopi_htmlentities(strip_tags($fields['title'], '<b><i>')),
                              'SUBTITLE_CLEAN' => ploopi_htmlentities(strip_tags($fields['subtitle'], '<b><i><a>')),
                              'DESCRIPTION' => strip_tags($fields['subtitle'], '<b><i><a>'),
                              'DESCRIPTION_CLEAN' => ploopi_htmlentities(strip_tags($fields['subtitle'], '<b><i><a>')),
                              'CONTENT' => strip_tags($fields['content'], '<b><i><a>'),
                              'CONTENT_CLEAN' => ploopi_htmlentities(strip_tags($fields['content'], '<b><i><a>')),
