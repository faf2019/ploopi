...
?>
<form name="form_field" action="<?php echo ploopi\crypt::urlencode('admin.php?'.implode('&', $arrParams)); ?>" method="post"  onsubmit="javascript:return forms_graphic_validate(this);">
<div style="overflow:hidden">
    <div style="float:left;width:50%;">
        <div class="ploopi_form" style="padding:4px;">
            <p>
                <label><?php echo _FORMS_GRAPHIC_LABEL; ?>:</label>
                <input type="text" class="text" name="forms_graphic_label" value="<?php echo ploopi\str::htmlentities($objGraphic->fields['label']); ?>">
            </p>
            <p>
                ...
                {
                     ?>
                     <option value="<?php echo ploopi\str::htmlentities($strKey); ?>" <?php echo ($strKey == $objGraphic->fields['type']) ? 'selected="selected"' : ''; ?>><?php echo ploopi\str::htmlentities($strValue); ?></option>
                     <?php
                }
                ?>
                </select>
            ...
            <p>
                ...
                <textarea class="text" name="forms_graphic_description"><?php echo ploopi\str::htmlentities($objGraphic->fields['description']); ?></textarea>
            </p>
            <p>
            ...
            <p class="ploopi_va forms_param_link" id="forms_graphic_params_link" style="display:block;">
                <a onclick="javascript:jQuery('#forms_graphic_params_link')[0].style.display = 'none'; jQuery('#forms_graphic_params')[0].style.display = 'block';" href="javascript:void(0);">
                ...
                <fieldset>
                    ...
                    <p>
                        ...
                        <select class="select" name="forms_graphic_param_font">
                            ...
                            {
                                ?>
                                <option <?php if ($objGraphic->fields['param_font'] == $key) echo 'selected="selected"'; ?> value="<?php echo ploopi\str::htmlentities($key); ?>"><?php echo ploopi\str::htmlentities($value); ?></option>
                                <?php
                            }
                            ?>
                        </select>
                    ...
                    <p>
                        ...
                        <input type="text" class="text" style="width:40px;margin-right:2px;" name="forms_graphic_param_font_size_title" value="<?php echo ploopi\str::htmlentities($objGraphic->fields['param_font_size_title']); ?>" />
                    </p>
                    <p>
                        <label>Taille de la légende:</label>
                        <input type="text" class="text" style="width:40px;margin-right:2px;" name="forms_graphic_param_font_size_legend" value="<?php echo ploopi\str::htmlentities($objGraphic->fields['param_font_size_legend']); ?>" />
                    </p>
                    <p>
                        <label>Taille des données:</label>
                        <input type="text" class="text" style="width:40px;margin-right:2px;" name="forms_graphic_param_font_size_data" value="<?php echo ploopi\str::htmlentities($objGraphic->fields['param_font_size_data']); ?>" />
                    </p>
                </fieldset>
                <fieldset>
                    ...
                    <p>
                        ...
                        <input type="text" class="text" style="width:40px;margin-right:2px;" name="forms_graphic_param_margin_left" value="<?php echo ploopi\str::htmlentities($objGraphic->fields['param_margin_left']); ?>" />
                        <input type="text" class="text" style="width:40px;margin-right:2px;" name="forms_graphic_param_margin_right" value="<?php echo ploopi\str::htmlentities($objGraphic->fields['param_margin_right']); ?>" />
                        <input type="text" class="text" style="width:40px;margin-right:2px;" name="forms_graphic_param_margin_top" value="<?php echo ploopi\str::htmlentities($objGraphic->fields['param_margin_top']); ?>" />
                        <input type="text" class="text" style="width:40px;margin-right:2px;" name="forms_graphic_param_margin_bottom" value="<?php echo ploopi\str::htmlentities($objGraphic->fields['param_margin_bottom']); ?>" />
                    </p>
                    <p>
                        <label>Rotation des libellés (%):</label>
                        <input type="text" class="text" style="width:40px;margin-right:2px;" name="forms_graphic_param_label_angle" value="<?php echo ploopi\str::htmlentities($objGraphic->fields['param_label_angle']); ?>" />
                    </p>
                </fieldset>
                <fieldset>
                ...
                <fieldset>
                    ...
                    <p>
                        ...
                        <select class="select" name="forms_graphic_param_mark_type">
                            ...
                            {
                                ?>
                                <option <?php if ($objGraphic->fields['param_mark_type'] == $key) echo 'selected="selected"'; ?> value="<?php echo ploopi\str::htmlentities($key); ?>"><?php echo ploopi\str::htmlentities($value); ?></option>
                                <?php
                            }
                            ?>
                        </select>
                    ...
                    <p>
                        ...
                        <input type="text" class="text" style="width:40px;margin-right:2px;" name="forms_graphic_param_mark_width" value="<?php echo ploopi\str::htmlentities($objGraphic->fields['param_mark_width']); ?>" />
                    </p>
                    <p>
        ...
        <div class="ploopi_form" style="padding:4px;">
            <div id="forms_graphic_pie" style="display:<?php echo in_array($objGraphic->fields['type'], array('pie', 'pie3d')) ? 'block' : 'none'; ?>">
                <fieldset>
                    ...
                    <p>
                        ...
                        <select class="select" name="forms_graphic_pie_field">
                            ...
                            foreach($arrFields as $intIdField => $arrField)
                            {
                                ...
                                {
                                    ?>
                                     <option value="<?php echo $intIdField; ?>" <?php echo ($intIdField == $objGraphic->fields["pie_field"]) ? 'selected="selected"' : ''; ?>><?php echo ploopi\str::htmlentities($arrField['name']); ?></option>
                                    <?php
                                }
                            }
                            ?>
                    ...
                    <p>
                        ...
                        <input type="text" class="text forms_noselect color {hash:true}" name="forms_graphic_pie_color1" id="forms_graphic_pie_color1" value="<?php echo ploopi\str::htmlentities($objGraphic->fields["pie_color1"]); ?>" style="float:left;width:100px;cursor:pointer;" readonly="readonly">
                    </p>
                    <p>
                        <label>Couleur de dégradé 2:</label>
                        <input type="text" class="text forms_noselect color {hash:true}" name="forms_graphic_pie_color2" id="forms_graphic_pie_color2" value="<?php echo ploopi\str::htmlentities($objGraphic->fields["pie_color2"]); ?>" style="float:left;width:100px;cursor:pointer;" readonly="readonly">
                    </p>
                </fieldset>
            </div>
            <div id="forms_graphic_line" style="display:<?php echo in_array($objGraphic->fields['type'], array('line', 'linec', 'bar', 'barc', 'radar', 'radarc')) ? 'block' : 'none'; ?>">
                <p>
                    ...
                    <select class="select" name="forms_graphic_timefield">
                        ...
                        foreach($arrFields as $intIdField => $arrField)
                        {
                            ...
                            {
                                ?>
                                 <option value="<?php echo $intIdField; ?>" <?php echo ($intIdField == $objGraphic->fields["timefield"]) ? 'selected="selected"' : ''; ?>>Champ "<?php echo ploopi\str::htmlentities($arrField['name']); ?>"</option>
                                <?php
                            }
                        }
                        ?>
                ...
                <p>
                    ...
                    {
                         ?>
                         <option value="<?php echo ploopi\str::htmlentities($strKey); ?>" <?php echo ($strKey == $objGraphic->fields['line_aggregation']) ? 'selected="selected"' : ''; ?>><?php echo ploopi\str::htmlentities($strValue); ?></option>
                         <?php
                    }
                    ?>
                    </select>
                ...
                for ($intI = 1; $intI <= 5; $intI++)
                {
                    ...
                    ?>
                        <div style="display:<?php echo ploopi\str::htmlentities($strDisplay); ?>;" id="forms_graphic_line<?php echo $intI; ?>_param">
                        <fieldset>
                            ...
                            <p>
                                ...
                                <select class="select" name="forms_graphic_line<?php echo $intI; ?>_filter">
                                    ...
                                    foreach($arrFields as $intIdField => $arrField)
                                    {
                                        ...
                                        {
                                            ?>
                                             <option value="<?php echo $intIdField; ?>" <?php echo ($intIdField == $objGraphic->fields["line{$intI}_filter"]) ? 'selected="selected"' : ''; ?>><?php echo ploopi\str::htmlentities($arrField['name']); ?></option>
                                            <?php
                                        }
                                    }
                                    ?>
                            ...
                            <p>
                                ...
                                <select class="select" style="width:20%;" name="forms_graphic_line<?php echo $intI; ?>_filter_op">
                                    ...
                                    {
                                         ?>
                                         <option value="<?php echo ploopi\str::htmlentities($strKey); ?>" <?php echo ($strKey == $objGraphic->fields["line{$intI}_filter_op"]) ? 'selected="selected"' : ''; ?>><?php echo ploopi\str::htmlentities($strValue); ?></option>
                                         <?php
                                    }
                                    ?>
                                </select>
                                <input style="width:43%;" type="text" class="text" name="forms_graphic_line<?php echo $intI; ?>_filter_value" id="forms_graphic_line<?php echo $intI; ?>_filter_value" value="<?php echo ploopi\str::htmlentities($objGraphic->fields["line{$intI}_filter_value"]); ?>">
                            </p>
                            <p>
                                ...
                                <select class="select" name="forms_graphic_line<?php echo $intI; ?>_field">
                                    ...
                                    foreach($arrFields as $intIdField => $arrField)
                                    {
                                        ...
                                        {
                                            ?>
                                             <option value="<?php echo $intIdField; ?>" <?php echo ($intIdField == $objGraphic->fields["line{$intI}_field"]) ? 'selected="selected"' : ''; ?>><?php echo ploopi\str::htmlentities($arrField['name']); ?></option>
                                            <?php
                                        }
                                    }
                                    ?>
                            ...
                            <p>
                                ...
                                <select class="select" name="forms_graphic_line<?php echo $intI; ?>_operation">
                                    ...
                                    {
                                         ?>
                                         <option value="<?php echo ploopi\str::htmlentities($strKey); ?>" <?php echo ($strKey == $objGraphic->fields["line{$intI}_operation"]) ? 'selected="selected"' : ''; ?>><?php echo ploopi\str::htmlentities($strValue); ?></option>
                                         <?php
                                    }
                                    ?>
                                </select>
                            ...
                            <p>
                                <label>Couleur :</label>
                                <input type="text" class="text forms_noselect color {hash:true}" name="forms_graphic_line<?php echo $intI; ?>_color" id="forms_graphic_line<?php echo $intI; ?>_color" value="<?php echo ploopi\str::htmlentities($objGraphic->fields["line{$intI}_color"]); ?>" style="float:left;width:100px;cursor:pointer;" readonly="readonly" />
                            </p>
                            <p>
                                <label>Légende (optionnelle) :</label>
                                <input type="text" class="text" name="forms_graphic_line<?php echo $intI; ?>_legend" value="<?php echo ploopi\str::htmlentities($objGraphic->fields["line{$intI}_legend"]); ?>" />
                            </p>
