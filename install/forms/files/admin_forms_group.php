        ...
        for ($intI = 1; $intI <= ploopi_getparam('form_nb_cond'); $intI++)
        {
            ...
            <p>
                ...
                <select class="select" style="width:20%;" name="_forms_group_cond[<?php echo $intI; ?>][op]">
                    ...
                    {
                         ?>
                         <option value="<?php echo ploopi_htmlentities($strKey); ?>" <?php echo (isset($arrConditions[$intI]['op']) && $strKey == $arrConditions[$intI]['op']) ? 'selected="selected"' : ''; ?>><?php echo $strValue; ?></option>
                         <?php
                    }
                    ?>
                </select>
