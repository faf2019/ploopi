    ...
    if (ploopi\acl::isactionallowed(_FORMS_ACTION_FILTER))
    {
        ...
        <div id="forms_filter_box"  style="display:<?php echo ploopi\str::htmlentities($_SESSION['forms'][$_SESSION['ploopi']['moduleid']]['forms_filter_box']); ?>;">
            ...
            <p>
                ...
                {
                    ?>
                    <input type="button" class="flatbutton" value="Supprimer les données filtrées" onclick="javascript:if (confirm('Attention, cette action va supprimer définitivement les données filtrées, continuer ?')) {jQuery('#filtre_frm')[0].op.value='forms_deletedata';jQuery('#filtre_frm')[0].submit();}">
                    <?php
                }
                ?>
