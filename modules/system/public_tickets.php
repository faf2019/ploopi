...
<div id="system_tickets_titlebar">
	...
	<div>
		<b><? echo _SYSTEM_LABELTAB_MESSAGEINBOX; ?></b> - <a href="javascript:void(0);" onclick="javascript:system_tickets_new(event);">Nouveau message</a>
		&nbsp;&nbsp;&nbsp;&nbsp;<b>Filtre:</b>
...
for  ($i=0; $i<$nb_tickets_page && !empty($ticket); $i++)
{
	...
	<div class="system_tickets_row" style="background-color:<? echo $color; ?>;">
		<div class="system_tickets_head"  onclick="javascript:system_tickets_display(<? echo $fields['id']; ?>,<? echo (empty($fields['status'])) ? 0 : 1; ?>,1,'<? echo $_SESSION['ploopi']['template_path']; ?>');">
			...
			elseif ($fields['needed_validation'] == 1 && $fields['sender_uid'] != $_SESSION['ploopi']['userid'] && !isset($tickets[$fields['id']]['dest'][$_SESSION['ploopi']['userid']]['status'][_PLOOPI_TICKETS_DONE]))
			{
			...
			<div class="system_tickets_count_read"><? echo $fields['count_read']; ?></div>
			<div class="system_tickets_count_replies"><? echo $fields['count_replies']; ?></div>
		...
		<div class="system_tickets_detail"  id="tickets_detail_<? echo $fields['id'];?>">
			...
			<div class="system_tickets_buttons">
				<p class="ploopi_va">
					...
					{
						?>
						<a href="javascript:ploopi_confirmlink('<? echo "{$scriptenv}?ploopi_op=tickets_delete&ticket_id={$fields['id']}"; ?>','Êtes-vous certain de vouloir supprimer ce ticket ?');"><img src="<? echo $_SESSION['ploopi']['template_path']; ?>/img/system/email_delete.png">Effacer</a>
						<?
					}
					?>
				</p>
...
?>
<div class="system_tickets_legend">
	<div>Légende:</div>
	<img src="<? echo $_SESSION['ploopi']['template_path']; ?>/img/system/email_read.png"><div>déjà vu</div>
	<img src="<? echo $_SESSION['ploopi']['template_path']; ?>/img/system/email_new.png"><div>nouveau</div>
	<img src="<? echo $_SESSION['ploopi']['template_path']; ?>/img/system/attention.png"><div>à valider</div>
	<img src="<? echo $_SESSION['ploopi']['template_path']; ?>/img/system/p_red.png"><div>non lu</div>
	<img src="<? echo $_SESSION['ploopi']['template_path']; ?>/img/system/p_blue.png"><div>lu</div>
	<img src="<? echo $_SESSION['ploopi']['template_path']; ?>/img/system/p_green.png"><div>validé</div>
</div>
