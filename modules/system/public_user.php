    ...
    <div style="float:left;width:49%" class="ploopi_form">
        <div style="padding:2px;">
            <p>
                ...
                <span><strong><?php echo $user->fields['login']; ?></strong></span>
            </p>
            <p>
            ...
            <p>
                ...
                <span>
                <div><a href="javascript:void(0);" onclick="javascript:system_choose_photo(event, '<?php echo $user->fields['id']; ?>');">Choisir une photo</a></div>
