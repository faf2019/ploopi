...
else
{
    ...
    <form id="form_modparam" action="<?php echo ovensia\ploopi\crypt::urlencode('admin.php'); ?>" method="post">
        ...
        foreach($modules as $mod)
        {
            ...
            ?>
                <option <?php if ($idmodule == $mod['instanceid']) echo 'selected'; ?> value="<?php echo $mod['instanceid']; ?>"><?php echo ovensia\ploopi\str::htmlentities("{$mod['instancename']} ({$mod['label']})"); ?></option>
            <?php
        }
        ?>
        </select>
            ...
            foreach($arrParam as $name => $param)
            {
                ...
                <p>
                    ...
                    else
                    {
                        ...
                        {
                            ?>
                            <textarea class="text" name="<?php echo ovensia\ploopi\str::htmlentities($name); ?>"><?php echo ovensia\ploopi\str::htmlentities($param['value']); ?></textarea>
                            <?php
                        }
                        else
                        {
