    ...
    <div class="ploopi_form" style="float:left;width:50%;">
        <div style="padding:2px;">
            ...
            <p>
                ...
                <input type="text" class="text" name="user_office"  value="<?php echo htmlentities($user->fields['office']); ?>" tabindex="5" />
            </p>
            <p>
                <label><?php echo _SYSTEM_LABEL_FUNCTION; ?>:</label>
                <input type="text" class="text" name="user_function"  value="<?php echo htmlentities($user->fields['function']); ?>" tabindex="6" />
            </p>
            <p>
                <label><?php echo _SYSTEM_LABEL_NUMBER; ?>:</label>
                <input type="text" class="text" name="user_number"  value="<?php echo htmlentities($user->fields['number']); ?>" tabindex="6" />
            </p>
            <p>
                <label><?php echo _SYSTEM_LABEL_PHONE; ?>:</label>
                <input type="text" class="text" name="user_phone"  value="<?php echo htmlentities($user->fields['phone']); ?>" tabindex="7" />
            </p>
            <p>
                <label><?php echo _SYSTEM_LABEL_MOBILE; ?>:</label>
                <input type="text" class="text" name="user_mobile"  value="<?php echo htmlentities($user->fields['mobile']); ?>" tabindex="8" />
            </p>
            <p>
                <label><?php echo _SYSTEM_LABEL_FAX; ?>:</label>
                <input type="text" class="text" name="user_fax"  value="<?php echo htmlentities($user->fields['fax']); ?>" tabindex="9" />
            </p>
            <p>
                <label><?php echo _SYSTEM_LABEL_ADDRESS; ?>:</label>
                <textarea class="text" name="user_address" tabindex="10"><?php echo htmlentities($user->fields['address']); ?></textarea>
            </p>
            <p>
                <label><?php echo _SYSTEM_LABEL_POSTALCODE; ?>:</label>
                <input type="text" class="text" name="user_postalcode"  value="<?php echo htmlentities($user->fields['postalcode']); ?>" tabindex="11" />
            </p>
            <p>
                <label><?php echo _SYSTEM_LABEL_CITY; ?>:</label>
                <input type="text" class="text" name="user_city"  value="<?php echo htmlentities($user->fields['city']); ?>" tabindex="12" />
            </p>
            <p>
                <label><?php echo _SYSTEM_LABEL_COUNTRY; ?>:</label>
                <input type="text" class="text" name="user_country"  value="<?php echo htmlentities($user->fields['country']); ?>"  tabindex="13" />
            </p>
        </div>
    </div>
    <div style="float:left;width:50%;" class="ploopi_form">
        <div style="padding:2px;">
            <p>
                ...
                {
                    ?>
                    <span><?php echo htmlentities($user->fields['login']); ?></span>
                    <?php
                }
                ?>
            </p>
            ...
            <p>
                ...
                <input type="text" style="width:100px;" class="text" name="user_date_expire" id="user_date_expire" value="<?php echo $user_date_expire['date']; ?>" tabindex="27" />
            ...
            <p>
                ...
                <input type="text" class="text" name="user_email"  value="<?php echo htmlentities($user->fields['email']); ?>" tabindex="24" />
            </p>
            <p class="checkbox" onclick="javascript:ploopi_checkbox_click(event,'user_ticketsbyemail');">
                ...
                <input style="width:16px;" type="checkbox" id="user_ticketsbyemail" name="user_ticketsbyemail" value="1" <?php if ($user->fields['ticketsbyemail']) echo 'checked'; ?> tabindex="25" />
            </p>
            ...
            <p class="checkbox" onclick="javascript:ploopi_checkbox_click(event,'user_servertimezone');">
                ...
                <span>
                    <input style="width:16px;" type="checkbox" id="user_servertimezone" name="user_servertimezone" value="1" <?php if ($user->fields['servertimezone']) echo 'checked'; ?> tabindex="25" onchange="$('user_timezone_choice').style.display = (this.checked) ? 'none' : 'block';"/>
            ...
            <p>
                ...
                <textarea class="text" name="user_comments" tabindex="28"><?php echo htmlentities($user->fields['comments']); ?></textarea>
            </p>
            <p>
